...
function Home() {
  ...
  return (
    <>
      <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '12px', background: '#ff7b00', zIndex: 1000 }}></div>
      <div className="app-container" style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', fontFamily: '"Orbitron", sans-serif' }}>
      <div className="title-anim-wrapper">
        <div className="title-paint-bg"></div>
        <h1 className="title title-text-reveal">Canvas³</h1>
      ...
      <div className="glass-panel" style={{ textAlign: 'center', padding: '2rem', width: '100%', marginBottom: '2rem' }}>
        <h2 style={{ fontSize: '1.8rem', marginBottom: '1.5rem', color: 'var(--text-main)', fontFamily: '"Orbitron", sans-serif', lineHeight: '1.4' }}>
          Canvas³は、直感的な操作で<span style={{ color: '#3b82f6' }}>2D</span>と<span style={{ color: '#ff7b00' }}>3D</span>のアートワークを自由に作成できるWebアプリケーションです。
        </h2>
        ...
        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', flexWrap: 'wrap', gap: '2rem', padding: '0 1rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '1rem', flex: 1, minWidth: '300px', maxWidth: '450px', backgroundColor: 'rgba(255,255,255,0.6)', padding: '1.5rem', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
            <h3 style={{ margin: '0', fontSize: '1.2rem', backgroundColor: '#ff7b00', color: '#ffffff', padding: '0.4rem 1rem', borderRadius: '8px', alignSelf: 'flex-start', fontWeight: 'bold' }}>
              3D空間で自由にアートを描こう！
            </h3>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '1rem', flex: 1, minWidth: '300px', maxWidth: '450px', backgroundColor: 'rgba(255,255,255,0.6)', padding: '1.5rem', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
            <h3 style={{ margin: '0', fontSize: '1.2rem', backgroundColor: '#3b82f6', color: '#ffffff', padding: '0.4rem 1rem', borderRadius: '8px', alignSelf: 'flex-start', fontWeight: 'bold' }}>
              シンプルなお絵描きを楽しもう！
            </h3>
            <p style={{ margin: 0, fontSize: '1.1rem', color: '#000000', textAlign: 'left', width: '100%', lineHeight: '1.5' }}>
